  ...
  <v-app id="app">
    ...
    <div class="mindmap_detail">
      ...
      <v-card class="mx-auto" width="100%" flat outlined style="margin-top: 8px">
        ...
        <!-- 작성자 -->
        <v-card-title @click="getUserEmail(mindmap.admin, nickName, profileImage)">
    ...
    getNickName() {
      ...
      this.$store.dispatch('readMemberList', form1).then(() => {
        ...
        for (var j = 0; j < this.members.length; j++) {
          if (this.members[j].email === this.mindmap.admin)
            this.nickName = this.members[j].nickName;
        }
      });
    },
  },
